...
<div id="content">
<!-- 关于表单样式，请自行调整-->
<form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>" style="padding: 15px; margin-top: 5px; background-color: #fff;">
    <div class="shuru">
...
background-color: #eee;">
        ...
        <input type="submit" value="提交" style="cursor: pointer; background-color: #1F63B1; font-family: 微软雅黑; color: #ffffff; height: 50px; line-height: 50px; width: 70%; font-size: 16px; float: left;margin-right: 1px;" />
        <input type="reset" value="重填" style="cursor: pointer; width: 29.8%; height: 50px; background-color: #FF8800; font-family: 微软雅黑; color: #fff; font-size: 16px; "/></div>
</form>
</div>
<?php get_footer(); ?>